...
public enum OperationalTemplateTestData {
  ...
  SECTION_CARDINALITY(
      "Cardinality test template sections", "section_cardinality.opt", "cardinality_of_section"),
  ...
  ISM_MISSING(
      "ISM withn missing transition", "test-ism.vitagroup.de.v1.opt", "test-ism.vitagroup.de.v1"),
  ISM_WRONG(
